...
//   IconButton lastIconClicked = IconButton(onPressed: (){}, icon: Icon(Icons.notifications));
//   final List <IconButton> menuItems = <IconButton> [
...
//         children: menuItems.map <Widget> ((IconButton icon) => Padding(
